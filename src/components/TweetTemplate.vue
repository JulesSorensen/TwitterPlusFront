    ...
    <div
        ...
        <div @click="openTweet">
            <div class="flex flex-row items-center ml-2">
                <div class="h-10 w-10">
                    <img v-if="!!tweet.authorPicture" class="rounded-full h-10 w-10" v-bind:src="tweet.authorPicture"
        ...
        <div v-if="!tweet.isRetweet" class="flex flex-row justify-around w-full h-fit px-10 select-none">
            <div @click="openTweet" class="flex flex-row items-center space-x-3 group">
                <svg class="dark:fill-gray-400 group-hover:fill-gray-500 black:group-hover:fill-gray-200" width="18px"
            ...
            <div @click="retweetTweet" class="flex flex-row items-center space-x-3 group">
                <svg v-if="tweet.retweeted"
                    class="dark:fill-green-400 group-hover:fill-green-500 black:group-hover:fill-green-200" width="18px"
                    height="18px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                    <path
                        d="M272 416c17.7 0 32-14.3 32-32s-14.3-32-32-32H160c-17.7 0-32-14.3-32-32V192h32c12.9 0 24.6-7.8 29.6-19.8s2.2-25.7-6.9-34.9l-64-64c-12.5-12.5-32.8-12.5-45.3 0l-64 64c-9.2 9.2-11.9 22.9-6.9 34.9s16.6 19.8 29.6 19.8l32 0 0 128c0 53 43 96 96 96H272zM304 96c-17.7 0-32 14.3-32 32s14.3 32 32 32l112 0c17.7 0 32 14.3 32 32l0 128H416c-12.9 0-24.6 7.8-29.6 19.8s-2.2 25.7 6.9 34.9l64 64c12.5 12.5 32.8 12.5 45.3 0l64-64c9.2-9.2 11.9-22.9 6.9-34.9s-16.6-19.8-29.6-19.8l-32 0V192c0-53-43-96-96-96L304 96z" />
                </svg>
            ...
            <div @click="likeTweet" class="flex flex-row items-center space-x-3 group">
                <svg v-if="tweet.liked"
                    class="dark:fill-red-400 group-hover:fill-red-500 black:group-hover:fill-red-200" width="18px"
                    height="18px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    <path
            ...
            <div @click="bookmarkTweet" class="flex flex-row items-center space-x-3 group">
                <svg v-if="tweet.bookmarked"
                    class="dark:fill-green-400 group-hover:fill-green-500 black:group-hover:fill-green-200" width="18px"
                    height="18px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                    <path
