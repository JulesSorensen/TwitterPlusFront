<template>
  <div class="flex flex-col lg:flex-row lg:justify-around w-screen h-screen lg:px-10">
    ...
    <div class="flex flex-col hidden lg:block space-y-13 w-fit h-full pt-10 px-16 flex">
      <TweetSearch />
      <PeopleSuggestion />
    </div>
  </div>
